...
This is a fully functional Jenkins server, based on the official jenkins container: https://registry.hub.docker.com/_/jenkins/ .  The main difference is that this container has the chef client installed. test
